      ...
      <div className="max-w-wrapper w-full md:grid flex flex-col grid-cols-2 gap-10">
        ...
        <div className="bg-primary rounded-lg md:p-10 p-4 text-textLight flex flex-col  gap-10 shadow-xl">
          ...
          <a
            ...
            className="text-2xl uppercase cursor-pointer text-primary font-semibold py-3 px-6 bg-textLight  rounded-lg flex items-center justify-center hover:scale-105 transition-all ease-in-out"
          >
            Koupit
          </a>
        </div>
