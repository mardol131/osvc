    ...
    <div className=" min-h-200 flex items-center justify-center px-10 border-b">
      <div className="max-w-wrapper w-full grid grid-cols-2 gap-10">
        ...
        <div className="bg-primary rounded-lg p-10 text-textLight flex flex-col  gap-10">
          <div>
            <h3>Cena</h3>
            <p className="text-7xl font-bebas">{servicePrice} Kč za rok</p>
            <p className="font-semibold">(Zhruba tři kávy)</p>
          ...
          <button className="text-2xl text-primary font-semibold py-3 px-6 bg-textLight  rounded-lg flex items-center justify-center">
            Koupit
          </button>
        </div>
      </div>
