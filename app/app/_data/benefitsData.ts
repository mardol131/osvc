export const benefitsData = {
  ...
  audience: {
    ...
    points: [
      "Začínající podnikatelé, kteří chtějí mít jistotu, že na nic nezapomenou.",
      "Zaneprázdnění živnostníci, kteří nechtějí trávit čas studiem zákonů.",
      "Každý, kdo chce předejít pokutám a mít klid na práci.",
    ],
  },
  cta: {
