...
export const businessActivities: BusinessActivity[] = [
  {
    id: process.env.STRIPE_IT_SERVICES_PRODUCT_ID || "it_services",
    priceId: process.env.STRIPE_IT_SERVICES_PRICE_ID || "it_services_price",
  ...
  {
    id: process.env.STRIPE_TRADING_PRODUCT_ID || "trading",
  ...
  {
    id: process.env.STRIPE_CONSULTING_PRODUCT_ID || "consulting",
    priceId: process.env.STRIPE_CONSULTING_PRICE_ID || "consulting_price",
  ...
  {
    id: process.env.STRIPE_MARKETING_PRODUCT_ID || "marketing",
    priceId: process.env.STRIPE_MARKETING_PRICE_ID || "marketing_price",
  ...
  {
    id: process.env.STRIPE_EDUCATION_PRODUCT_ID || "education",
    priceId: process.env.STRIPE_EDUCATION_PRICE_ID || "education_price",
  ...
  {
    id: process.env.STRIPE_CULTURE_SPORT_PRODUCT_ID || "culture_sport",
    priceId: process.env.STRIPE_CULTURE_SPORT_PRICE_ID || "culture_sport_price",
