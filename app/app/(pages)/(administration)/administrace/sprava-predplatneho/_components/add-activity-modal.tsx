    ...
    >
      {canBeAdded ? (
        <form onSubmit={onSubmit} className="flex flex-col">
          ...
          <div className="bg-emerald-50 border-l-4 border-emerald-500 rounded-lg p-4 mb-6">
            <p className="text-sm text-zinc-600 leading-relaxed">
              Cena je dopočítána podle zbývajícího období vašeho předplatného.
              Po jeho vypršení bude tato skupina předmětů podnikání účtována za{" "}
              <span className="font-semibold">{group.price} Kč/rok</span>.
              Skupina předmětů podnikání bude ihned dostupná pro další měsíc.
            </p>
          </div>
            ...
            <CustomCheckbox
              ...
              label={
                <span className="text-sm text-zinc-600 leading-relaxed">
                  Souhlasím s okamžitým stržením částky z platební karty
                  nastavené pro předplatné
                </span>
              }
            />
        ...
        <div className="flex flex-col gap-4">
          <p>Tuto skupinu předmětů bohužel nelze přidat.</p>
          <Button onClick={onClose} text="Zavřít okno" />
        </div>
      )}
    </ModalLayout>
  );
